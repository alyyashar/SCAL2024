...
class Execution_Configuration:
    ...
    def __init__(self, output_folder: str, execution_name: str, is_bytecode: bool, skip_existing: bool, sarif_output: bool,  operations: int, aggregate_sarif: bool, unique_sarif_output: bool, timeout: int, cpu_quota: int, mem_quota: str, tools: List[str], files: List[str], datasets: List[str], arguments_passed = None):
