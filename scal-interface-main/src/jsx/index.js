...
import ContractMonitor from "./components/Dashboard/ContractMonitor";  // Correct import path
        ...
        <div className={`${!pagePath ? "content-body" : ""}`}>
          ...
          >
            <Switch>
              ...
              {/* Add the ContractMonitor route */}
              <Route exact path="/contract-monitor">
                <ContractMonitor contractAddress="0xYourContractAddress" />
              </Route>
