                                ...
                                <div className="card-body">
                                    <div className="basic-form">
                                        <form onSubmit={(e) => e.preventDefault()}>
                                            ...
                                            <div className="form-group mb-3">
                    <label>Select a bytecode to analyze:</label>
                    <select
                      defaultValue={"option"}
                      className="form-control"
                      id="sel1"
                    >
                      <option>BoredApe.hex</option>
                      <option>CryptoPunk.hex</option>
                      <option>RedWave.hex</option>
                      <option>WBTC.hex</option>
                    </select>
                  </div>
                                            <div className="form-group mb-3">
