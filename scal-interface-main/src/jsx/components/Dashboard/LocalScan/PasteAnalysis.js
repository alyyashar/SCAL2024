...
const PasteAnalysis = () => {
    ...
    async function onRunAnalysis(e) {
        ...
        setloader(true);
        axios
            .post(`https://5000-alyyashar-scal2024-zyixncvobqi.ws-eu115.gitpod.ioapi/file-input`, postData)
            .then((res) => {
                setResult(res);
    ...
    async function saveAnalysis() {
        ...
        axios
            .post(`https://5000-alyyashar-scal2024-zyixncvobqi.ws-eu115.gitpod.ioapi/user/updatescan/${isAuth()._id}`, saveData)
            .then((res) => {
