...
DATASET_CHOICES = ['all']
TOOLS_CHOICES = ['all']
CONFIG_TOOLS_PATH = os.path.abspath('scal/config/tools')
CONFIG_DATASET_PATH= os.path.abspath('scal/config/dataset/dataset.yaml')
...
class InfoAction(argparse.Action):
    def __call__(self, parser, namespace, values, option_string=None):
        for tool in values:
            cfg_path = os.path.abspath('scal/config/tools/' + tool + '.yaml')
