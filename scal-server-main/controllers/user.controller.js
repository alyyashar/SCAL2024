...
exports.updateScan = (req, res) => {
  const { id } = req.params;
  const { analysisName, noOfVulns, output, scanPeriod, fileType, toolUsed } =
    req.body;
  // find by document id and update and push item in array
  //console.log(analysisName, noOfVulns, output, scanPeriod, fileType, toolUsed);
  ...
  User.findById(id).exec((err, user) => {
    ...
    console.log('fetching user for scan details');
    email = user.email;
    console.log(email);
    name = user.name;
    ...
    //send mail to user about the saved scan info
    /*
