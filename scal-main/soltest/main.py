...
from soltest.exceptions import ContractsNotFound, SolcError
from soltest.install import get_executable
...
def compile_source(
    ...
    solc_binary : str | Path, optional
        ...
        version is used (as set by `soltest.set_solc_version`)
